...
class ProcessHousingLoanEvaluation
{
    use AsAction;
     ...
     * @throws Exception
     */
    public function handle(array $inputs, string $tempfilePath = null): array
    {
        $inputFileType = 'Xlsx';
        $inputFileName = docs_path("SHDG - Evaluation sheet V1-0-2 - 240819 new.xlsx");
